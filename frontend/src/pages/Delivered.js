...
const Delivered = () => {
  ...
  const [viewMode, setViewMode] = useState('pipelines'); // 'pipelines' or 'delivered'
                    ...
                    deliveredPipelines.map((item) => (
                      <tr key={item.pipeline_id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 text-sm">
                          {item.capacity_mrc_currency === 'USD' ? '$' : '৳'}{item.capacity_mrc.toLocaleString()}
                        </td>
                        <td className="px-6 py-4 text-sm">
                          {item.capacity_otc > 0 
                  ...
                  {delivered.length === 0 ? (
                    ...
                    delivered.map((item) => (
                      <tr key={item.delivered_id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 text-sm font-semibold text-blue-600" data-testid={`kpi-score-${item.delivered_id}`}>
                          {item.kpi_score || 0}
                        </td>
