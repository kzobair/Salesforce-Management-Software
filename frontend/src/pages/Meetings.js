...
const Meetings = () => {
  ...
  const handleEdit = (meeting) => {
    ...
    setFormData({
      ...
      capacity_unit: meeting.capacity_unit || 'Mbps',
      capacity_mrc: meeting.capacity_mrc,
      capacity_mrc_currency: meeting.capacity_mrc_currency || 'BDT',
      capacity_otc: meeting.capacity_otc || 0,
      capacity_otc_currency: meeting.capacity_otc_currency || 'BDT',
      other_cap_req: meeting.other_cap_req || 0,
      other_cap_unit: meeting.other_cap_unit || 'Mbps',
      other_cap_mrc: meeting.other_cap_mrc || 0,
      other_cap_mrc_currency: meeting.other_cap_mrc_currency || 'BDT',
      other_cap_otc: meeting.other_cap_otc || 0,
      other_cap_otc_currency: meeting.other_cap_otc_currency || 'BDT',
